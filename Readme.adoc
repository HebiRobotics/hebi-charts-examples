...
2D rendering builds on https://github.com/fair-acc/chart-fx[ChartFx], a high-performance scientific real-time charting library developed at the https://www.gsi.de/en/[GSI Helmholtz Centre for Heavy Ion Research] for the link:++https://fair-center.eu/[FAIR particle accelerator facility]++[FAIR particle accelerator facility].