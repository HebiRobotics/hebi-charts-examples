classdef (Sealed) HistogramTrace < hebi_charts.XYSeries
% Represents a latency measurement that records latency values in the form of an HdrHistogram
    ...
    methods
        ...
        function record(this, value)
            ...
            hebi_charts_native('hebi_charts_HistogramTrace_record', this.ref_HistogramTrace, value);
        end
        ...
        function recordWithCount(this, value, count)
            ...
            hebi_charts_native('hebi_charts_HistogramTrace_recordWithCount', this.ref_HistogramTrace, value, count);
        end
        ...
        function recordCompensated(this, value, expectedIntervalBetweenValueSamples)
            ...
            hebi_charts_native('hebi_charts_HistogramTrace_recordCompensated', this.ref_HistogramTrace, value, expectedIntervalBetweenValueSamples);
        end

        function reset(this)
            hebi_charts_native('hebi_charts_HistogramTrace_reset', this.ref_HistogramTrace);
        end

    end

    methods(Access = public, Hidden = true)
        function this = HistogramTrace(ref_HistogramTrace, varargin)
            this@hebi_charts.XYSeries(hebi_charts_native('hebi_charts_HistogramTrace_to_XYSeries', ref_HistogramTrace));
            this.ref_HistogramTrace = ref_HistogramTrace;
