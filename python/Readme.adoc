...
HEBI Charts features zero-configuration installation implemented inside link:./hebi_charts/hebi_charts.py[hebi_charts.py]. Running any of the examples automatically fetches the correct platform-specific binaries and stores them in a shared system cache. A dedicated native `pip` package distribution is currently in development.
