...
% A completely customizable view that is defined by FXML.
    ...
    methods
        ...
        function obj = addLineChart(this, fxId, varargin)
            ...
            if isempty(ptr_)
                error('Failed to create hebi_charts.LineChart in FxmlView.addLineChart');
            end
        ...
        function obj = addScope(this, fxId, varargin)
            ...
            if isempty(ptr_)
                error('Failed to create hebi_charts.LineChart in FxmlView.addScope');
            end
            obj = hebi_charts.LineChart(ptr_, varargin{:});
        end
        ...
        function obj = addLatencyChart(this, fxId, varargin)
            ...
            if isempty(ptr_)
                error('Failed to create hebi_charts.LatencyChart in FxmlView.addLatencyChart');
            end
        ...
        function obj = addScene3d(this, fxId, varargin)
            ...
            if isempty(ptr_)
                error('Failed to create hebi_charts.Scene3d in FxmlView.addScene3d');
            end
        ...
        function obj = addStreamView(this, file, fxId)
            ...
            if isempty(ptr_)
                error('Failed to create hebi_charts.StreamView in FxmlView.addStreamView');
            end
        ...
        function obj = addFxmlView(this, fxId, varargin)
            ...
            if isempty(ptr_)
                error('Failed to create hebi_charts.FxmlView in FxmlView.addFxmlView');
            end
    ...
    methods(Access = public, Hidden = true)
        function this = FxmlView(ptr, varargin)
            if ~isa(ptr, 'uint64') || ~isscalar(ptr)
                error('FxmlView instances are created by the library');
            end
            this.ptr = ptr;
