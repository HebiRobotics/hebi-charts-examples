...
Controls are also useful for creating simple interactive classroom demos, allowing students to focus on the underlying math or physics without dealing with complex UI framework overhead and asynchronous event callbacks.
